      ...
      <Container>
        <Section>
          ...
          <div className='paragraph'>
            ...
            <p>The dictionary Tuffet uses to identify rhymes isn't perfect, and its algorithm sometimes makes mistakes. In general, it does better with shorter stanzas than with long ones. At this time, it doesn't look for <strong>internal rhyme</strong> like <em>While I nodded, nearly napping, suddenly there came a tapping</em> or for <strong>mosaic rhyme</strong> like <em>Shakespeare&ndash;lake's pier</em>, instead focusing on end rhyme between single words. It also cannot identify rhymes that cross stanza-breaks.</p>
          </div>
        </Section>
        <Section>
